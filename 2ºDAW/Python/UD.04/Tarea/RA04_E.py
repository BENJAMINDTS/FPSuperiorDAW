"""
# RA04_E - Diccionario Anidado (Almacén)

Demuestra el uso de diccionarios anidados para representar un almacén con
productos que tienen precio y cantidad en stock.
Incluye consultas de precio, filtrado por stock bajo y cálculo del valor total.
"""

# Diccionario anidado: cada producto tiene un subdicionario con precio y stock
almacen = {
...
# ---- Consultar el precio de un producto concreto ----
producto_consultar = "Pantalón"
if producto_consultar in almacen:
    # Acceder al subdicionario del producto y obtener su precio
...
# ---- Mostrar productos con stock inferior a un valor dado ----
...
# ---- Calcular el valor total del stock (precio × cantidad por producto) ----
valor_total_stock = 0
for producto, detalles in almacen.items():
